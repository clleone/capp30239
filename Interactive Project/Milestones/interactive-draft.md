...
for scant cells versus overflowing ones? Not being familiar with the data, what
kind of bins do you think would be best from a general audience-UI perspective?
